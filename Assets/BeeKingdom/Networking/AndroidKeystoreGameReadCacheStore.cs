...
{
    public sealed class AndroidKeystoreGameReadCacheStore : IProtectedGameReadCacheStore
    {
        private const string KeyAlias = "bee_kingdom_game_read_cache_v1";
        private const string PreferencesName = "bee_kingdom_protected_game_read_cache_v1";
        private const string CiphertextKey = "cache_ciphertext";
        private const string InitializationVectorKey = "cache_iv";
        ...
        public Task SaveAsync(string protectedPlaintext, CancellationToken cancellationToken)
        {
            ...
            {
                throw Failure("game.cache.android_keystore_write_failed", exception);
            }
#else
            throw new InvalidOperationException("game.cache.protected_storage_unavailable");
#endif
        }
        ...
        public Task<string> LoadAsync(CancellationToken cancellationToken)
        {
            ...
            try
            {
                string ciphertext;
                string iv;
                if (!TryReadEncrypted(out ciphertext, out iv)) return Task.FromResult<string>(null);
            ...
            {
                throw Failure("game.cache.android_keystore_read_failed", exception);
            }
#else
        ...
        public Task DeleteAsync(CancellationToken cancellationToken)
        {
            ...
            {
                throw Failure("game.cache.android_keystore_delete_failed", exception);
            }
#endif
            return Task.CompletedTask;
        }
        ...
        public static string[] ProofRows()
        {
            return new[]
            {
                "android_game_cache_cipher:AES/GCM/NoPadding",
                "android_game_cache_key_provider:AndroidKeyStore",
                "android_game_cache_plaintext_preferences:false",
                "android_game_cache_ciphertext_preferences:true",
                "android_game_cache_key_exported:false",

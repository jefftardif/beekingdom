...
{
    public static class WorldMapWave6V2INativeAuditPreviewSceneBuilder
    {
        public const string CanonicalScenePath = "Assets/Scenes/WorldMapMmoFullscreenFoundation.unity";
        public const string PreviewScenePath = "Assets/Scenes/WorldMapWave6V2INativeAuditPreview.unity";
        private const string ReceiptPath = "Docs/BuilderA/WorldMapWave6_50x50_V2INativeAuditPreview/WorldMapWave6_V2INativeAuditPreviewSceneBuildReceipt.md";

        [MenuItem("Bee Kingdom/World Map/Build Wave6 V2I Native Audit Preview Scene")]
        public static void BuildPreviewScene()
        {
            ...
            try
            {
                ...
                bootstrap.SetV2INativeAuditPreviewRuntimePackageForPlayMode(true);
                EditorUtility.SetDirty(bootstrap);
                EditorSceneManager.MarkSceneDirty(bootstrap.gameObject.scene);
                Require(EditorSceneManager.SaveScene(bootstrap.gameObject.scene, PreviewScenePath), "V2I native audit preview scene could not be saved.");
        ...
        private static void WriteReceipt(string status, Exception exception)
        {
            ...
            builder.AppendLine("# WorldMap Wave6 V2I Native Audit Preview Scene Build");
            builder.AppendLine();
            ...
            builder.AppendLine("resource_root=" + WorldMapWave6StreamingTileProvider.V2INativeAuditPreviewResourceRoot);
            builder.AppendLine("source_master_sha256=" + WorldMapWave6StreamingTileProvider.V2INativeAuditPreviewExpectedMasterSha256);

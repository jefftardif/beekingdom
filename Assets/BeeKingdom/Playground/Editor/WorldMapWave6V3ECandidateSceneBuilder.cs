...
{
    public static class WorldMapWave6V3ECandidateSceneBuilder
    {
        public const string CanonicalScenePath = "Assets/Scenes/WorldMapMmoFullscreenFoundation.unity";
        public const string CandidateScenePath = "Assets/Scenes/WorldMapWave6V3ECandidate.unity";
        private const string ReceiptPath = "Docs/BuilderA/WorldMapWave6_50x50_V3ECandidate/WorldMapWave6_V3ECandidateSceneBuildReceipt.md";

        [MenuItem("Bee Kingdom/World Map/Build Wave6 V3E Candidate Scene")]
        public static void BuildCandidateScene()
        {
            ...
            try
            {
                ...
                bootstrap.SetV3ECandidateRuntimePackageForPlayMode(true);
                EditorUtility.SetDirty(bootstrap);
                EditorSceneManager.MarkSceneDirty(bootstrap.gameObject.scene);
                Require(EditorSceneManager.SaveScene(bootstrap.gameObject.scene, CandidateScenePath), "V3E candidate scene could not be saved.");
        ...
        private static void WriteReceipt(string status, Exception exception)
        {
            ...
            builder.AppendLine("# WorldMap Wave6 V3E Candidate Scene Build");
            builder.AppendLine();
            ...
            builder.AppendLine("candidate_scene=" + CandidateScenePath);

...
{
    public static class WorldMapWave6V2OPerimeterAuditPreviewSceneBuilder
    {
        public const string CanonicalScenePath = "Assets/Scenes/WorldMapMmoFullscreenFoundation.unity";
        public const string PreviewScenePath = "Assets/Scenes/WorldMapWave6V2OPerimeterAuditPreview.unity";
        private const string ReceiptPath = "Docs/BuilderA/WorldMapWave6_50x50_V2OPerimeterAuditPreview/WorldMapWave6_V2OPerimeterAuditPreviewSceneBuildReceipt.md";

        [MenuItem("Bee Kingdom/World Map/Build Wave6 V2O Perimeter Audit Preview Scene")]
        public static void BuildPreviewScene()
        {
            ...
            try
            {
                ...
                bootstrap.SetV2OPerimeterAuditPreviewRuntimePackageForPlayMode(true);
                EditorUtility.SetDirty(bootstrap);
                EditorSceneManager.MarkSceneDirty(bootstrap.gameObject.scene);
                Require(EditorSceneManager.SaveScene(bootstrap.gameObject.scene, PreviewScenePath), "V2O perimeter audit preview scene could not be saved.");
        ...
        private static void WriteReceipt(string status, Exception exception)
        {
            ...
            builder.AppendLine("# WorldMap Wave6 V2O Perimeter Audit Preview Scene Build");
            builder.AppendLine();
            ...
            builder.AppendLine("resource_root=" + WorldMapWave6StreamingTileProvider.V2OPerimeterAuditPreviewResourceRoot);
            builder.AppendLine("source_master_sha256=" + WorldMapWave6StreamingTileProvider.V2OPerimeterAuditPreviewExpectedMasterSha256);
